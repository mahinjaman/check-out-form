            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        {/* Email */}
                        <label htmlFor="email" className="mt-4 mb-2 block text-sm font-medium text-start">Email</label>
                        <div className="relative">
                            <input
                                type="email"
                                id="email"
                        ...
                        <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium text-start">Card Holder</label>
                        <div className="relative">
                            <input
                                type="text"
                                id="card-holder"
                        ...
                        <label htmlFor="Phone-no" className="mt-4 mb-2 block text-sm font-medium text-start">Phone No</label>
                        ...
                        <label htmlFor="billing-address" className="mt-4 mb-2 block text-sm font-medium text-start">Billing Address</label>
